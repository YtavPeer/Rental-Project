...
namespace YRental.Controllers
{
    ...
    public class OrdersController : ApiController
    {
        ...
        {
            return YRentDB.OrdersTable.ToList();
        }

        // GET: api/Orders/5
        public OrdersTable Get(int id)
        {
            return YRentDB.OrdersTable.FirstOrDefault(o => o.Order_ID==id);
        }
        ...
        {
            OrdersTable u =YRentDB.OrdersTable.FirstOrDefault(f => f.Order_ID == id);
            if (u != null) 
            {
                u.Car_ID = u1.Car_ID;
        ...
        {
            OrdersTable o = YRentDB.OrdersTable.FirstOrDefault(o1 => o1.Order_ID == id);
            if (o != null)
            {
                YRentDB.OrdersTable.Remove(o);
                YRentDB.SaveChanges();
            }
        }
    }
